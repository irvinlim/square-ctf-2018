 ...
 */
func main() {
	input := os.Args[0]							// took execution path as input argument instead (personal preference)
	input = "nxelvzqaifsyhojudrbcwgptmk"		// redefined input internally (for one-to-one mapping)
